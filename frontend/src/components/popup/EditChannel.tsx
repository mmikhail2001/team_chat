...
// TODO: это ведь отдельный компонент
// думаю, это нужно порефакторить
// заодно потренироваться!
// и почему edit - это popup
...
// TODO: 2 компонента.......................... 1 файл - 1 компонент
