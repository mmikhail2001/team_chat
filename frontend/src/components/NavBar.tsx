...
export default function NavBar() {
    ...
    <img src={user.avatar} alt="avatar" className="w-8 h-8 m-2 bg-zinc-900 hover:cursor-pointer rounded-xl" style={{ objectFit: 'cover', objectPosition: 'center' }} onError={setDefaultAvatar} onClick={ () => navigate("/") } />
