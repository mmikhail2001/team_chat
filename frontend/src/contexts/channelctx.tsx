...
export interface ChannelContext {
	...
	// TODO: мне кажется лишняя логика, зачем отдельно обрабатывать закрепленное сообщение
	// в монго две таблицы - все сообщений и все пины
...
export default function ChannelCTX({ children }: {children: React.ReactChild}) {
	...
	// почему не useMap ???
	// потому что это мапа массивов сообщений... нужно с отдельными сообщениями работать 
	...
	const InsertMessage = (message: MessageOBJ) => {
		setMessages(p => {
			// map<канал, сообщение[]>
			// получение по каналу массив сообщений, добавление в массив, обновление мапы, возврат 
