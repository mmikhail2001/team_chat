...
export default function FriendContextMenu(props: propsChannelCtxProps) {
    ...
    function Message() {
        GetDMChannel(props.friend_obj.id).then(response => {
    ...
    return (
        <div className='ContextMenu' style={style}>
            ...
            {/* исходящие запросы реально видны во вкладке panding */}
            {/* заявка в друзья - это тип отношений = 3, отклонить заявку = сделать тип отношений = 1 */}
