...
function Relationships() {
	...
	// какой из пунктов выбран All, Pending, Blocked, Add
	...
	useEffect(() => {
		...
		user_ctx.relationships.forEach(relationship => {
			...
			// 3 входящие запросы на дружбы, 4 - исходящие...
			// исходящие не показываются...
			// TODO: вроде показываются
			...
			if (add_friend_element) {
				// TODO: не проще было бы здесь через forEach заполнить???
				// как реакт понимает, когда нужно перерендерить... массив ведь заполняется на каждой итерации цикла
	...
	function SendFriendRequest() {
		// TODO: как бы это выглядело при использовании редакса
